...
var _category_detail = require('./components/category_detail.vue');

var _category_detail2 = _interopRequireDefault(_category_detail);

var _category_list = require('./components/category_list.vue');
...
new _vue2.default({
    el: "section.content",
    components: { CategoryDetail: _category_detail2.default, CategoryList: _category_list2.default },
    data: {
        newCategory: {
            name: '',
            saving: false
...
},{"./components/category_detail.vue":55,"./components/category_list.vue":56,"mout/number":6,"vue":51,"vue-resource":40}],54:[function(require,module,exports){
...
exports.default = {
	...
	ready: function ready() {
		console.log('ready from category component');
	}
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<li :class=\"act\">\n\t<a href=\"#\" @click=\"setActive\">\n\t    <i class=\"fa fa-box\"></i>\n\t    {{ category.name | capitalize }}\n\t    <span class=\"label label-info pull-right\">\n\t        {{ category.followers | abbreviate}}\n\t    </span>\n\t</a>\n</li>\n"
...
},{"mout/number":6,"vue":51,"vue-hot-reload-api":26,"vueify-insert-css":52}],55:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	ready: function ready() {
		...
		console.log('ready from category list component');
	},
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\t<ul class=\"nav nav-pills nav-stacked\" v-for=\"category in categories\">\n        <category :active.sync=\"active\" :category=\"category\"></category>\n    </ul>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"./category.vue":54,"vue":51,"vue-hot-reload-api":26,"vueify-insert-css":52}]},{},[53]);
