...
},{"../promise":42,"../util":49,"./before":26,"./client/default":27,"./cors":31,"./header":32,"./interceptor":34,"./jsonp":35,"./method":36,"./mime":37,"./timeout":38}],34:[function(require,module,exports){
/**
 * Interceptor factory.
 */
...
},{"./lib/util":51,"./lib/validates":52,"./lib/validator":53}],51:[function(require,module,exports){
/**
 * Utilties
 */
...
},{"./util":51,"./validates":52}],54:[function(require,module,exports){
/*!
 * Vue.js v1.0.14
 * (c) 2016 Evan You
...
new _vue2.default({
    ...
    methods: {
        ...
        saveAd: function saveAd() {
            ...
            var company_id = this.newAd.company_id;
    ...
    data: {
        savingCompany: false,
        savingAd: false,
        companies: [{ name: 'Airtel', id: 1 }, { name: 'Tigo', id: 2 }, { name: 'Glo', id: 3 }, { name: 'Vodafone', id: 4 }],
        ads: [],
        newCompany: {
            name: ''
        },
...
},{"mout/number":6,"vue":54,"vue-resource":39,"vue-validator":50}]},{},[55]);
