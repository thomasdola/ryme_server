        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box box-widget widget-user">
                    ...
                    <div class="widget-user-header bg-black" style="background: url('{{ asset("img/photo1.png", true) }}') center center;">
                        <h3 class="widget-user-username">Shatta Wale</h3>
                        <h5 class="widget-user-desc">DanceHall</h5>
                    </div>
                    <div class="widget-user-image">
                        <img class="img-circle" src="{{ asset('img/user3-128x128.jpg', true) }}" alt="User Avatar">
                    </div>
...
@section('scripts')
    <script src="{{ asset('js/user-profile.js', true) }}"></script>
@endsection